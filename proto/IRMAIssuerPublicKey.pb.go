...
type IRMAIssuerPublicKey struct {
	...
	Z           string   `protobuf:"bytes,4,opt,name=Z" json:"Z,omitempty"`
	S           string   `protobuf:"bytes,5,opt,name=S" json:"S,omitempty"`
	Bases       []string `protobuf:"bytes,6,rep,name=Bases" json:"Bases,omitempty"`
...
func (m *IRMAIssuerPublicKey) GetN() string {
	if m != nil {
		return m.N
	}
	return ""
...
func (m *IRMAIssuerPublicKey) GetZ() string {
	if m != nil {
		return m.Z
	}
	return ""
...
func (m *IRMAIssuerPublicKey) GetS() string {
	if m != nil {
		return m.S
	}
	return ""
...
func (m *IRMAIssuerPublicKey) GetBases() []string {
	if m != nil {
		return m.Bases
	}
	return nil
...
var fileDescriptor2 = []byte{
	...
	0xf1, 0x70, 0x31, 0xfa, 0x49, 0x30, 0x2b, 0x30, 0x6a, 0x70, 0x06, 0x31, 0xfa, 0x81, 0x78, 0x51,
	0x12, 0x2c, 0x10, 0x5e, 0x14, 0x88, 0x17, 0x2c, 0xc1, 0x0a, 0xe1, 0x05, 0x0b, 0x89, 0x70, 0xb1,
	0x3a, 0x25, 0x16, 0xa7, 0x16, 0x4b, 0xb0, 0x29, 0x30, 0x6b, 0x70, 0x06, 0x41, 0x38, 0x42, 0x0a,
	0x5c, 0xdc, 0xae, 0x05, 0xf9, 0xc9, 0x19, 0x3e, 0xa9, 0x79, 0xe9, 0x25, 0x19, 0x12, 0xec, 0x60,
	0xdb, 0x91, 0x85, 0x92, 0xd8, 0xc0, 0x4e, 0x37, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x07, 0x2a,
	0x57, 0x86, 0xe2, 0x00, 0x00, 0x00,
}
